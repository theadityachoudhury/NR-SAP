...
export default function Home() {
  ...
  async function submitForm() {
    ...
    /*     const res = await fetch("https://backend.unknownclub.me/api/auth/login", {
      method: "POST",
    ...
    let config = {
      ...
      url: "https://backend.unknownclub.me/api/auth/login",
      headers: {
  ...
  /* const handleLogin = (e: React.FormEvent) => {
    ...
    // Send the login data to the API using fetch or axios
    fetch("", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
